...
public class VolleyFragment extends Fragment implements View.OnClickListener, View.OnLayoutChangeListener {
    ...
    /** Activity reference. */
    private VolleyListActivity mActivity;
    ...
    public void onAttach(Context context) {
        ...
        mActivity = (VolleyListActivity) context;
    }
    ...
    public void onStop() {
        ...
        mActivity.getPreferences(Context.MODE_PRIVATE).edit().putInt("num_loaded_items", lastItemIndex).commit();
    }
